(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('ng2-completer'), require('rxjs'), require('lodash'), require('rxjs/operators'), require('@nebular/theme'), require('@nebular/eva-icons'), require('@angular/platform-browser'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ng2-smart-table', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'ng2-completer', 'rxjs', 'lodash', 'rxjs/operators', '@nebular/theme', '@nebular/eva-icons', '@angular/platform-browser', '@angular/common/http'], factory) :
    (global = global || self, factory(global['ng2-smart-table'] = {}, global.ng.core, global.ng.common, global.ng.forms, global.ng2Completer, global.rxjs, global.lodash, global.rxjs.operators, global.theme, global.evaIcons, global.ng.platformBrowser, global.ng.common.http));
}(this, function (exports, core, common, forms, ng2Completer, rxjs, lodash, operators, theme, evaIcons, platformBrowser, http) { 'use strict';
    ...
    var CellModule = /** @class */ (function () {
        ...
        CellModule = __decorate([
            core.NgModule({
                ...
                entryComponents: __spread(CELL_COMPONENTS),
